...
DOTNET_REF_DIR := $(DOTNET_BASE_DIR)../../packs/Microsoft.NETCore.App.Ref/6.0.10/ref/net6.0
...
Transpiled.cs: CiLexer.ci AST.ci Stubs.ci
	cito -o $@ -n Foxoft.Ci -r Stubs.ci CiLexer.ci AST.ci
